...
function FindIDModal({ onConfirm, ...props }) {
    ...
    <>
      <Modal {...props}>
        <Modal.Header closeButton className="pb-0">
          <Modal.Title className="font-16">{t("Find your ID.")}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          ...
          {step === 1 && (
            <div className="pb-30">
              ...
              <button
                className="mt-5 pt-20 pb-30 border-gray1-1px br-10 text-center w-100 bg-white"
                onClick={() => {
                  setStep(2);
                }}
              >
